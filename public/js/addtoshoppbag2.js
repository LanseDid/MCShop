                ...
                if(data.msg === "add success"){
                    ...
                    $(".movegoods").animate({
                        ...
                        $(".head-top-mid-rightli2-backgorund span").html(function (index,oldnum) {
                            ...
                            $(".head-top-mid-rightli2-backgorund .head-top-second").append("<dl><dt><img src='resource/imgs/details_magnifier_co21.jpg'></dt> <dd>Issey Miyake 三宅一生</dd> <dd>PVC 女士 手提包</dd> <dd>￥2360.00</dd> </dl>");
